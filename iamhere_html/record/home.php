...
<style>
div.para {
  border-radius:5px; background-color:#eee; padding:5px 5px 5px 5px;
  margin-bottom:10px;
}
div.para p { line-height:120%; margin-top:0px; margin-bottom:0px; }
...
<div class='para'>
<p>아래 버튼을 누르고, 작업을 수행할 때 사용하는 앱에서 텔레그램을 선택하세요.</p>
<p>텔레그렘에서 봇이 연결됩니다.</p>
<p>그리고 화면아래 '시작'을 누릅니다.</p>
</div>

<div class='button'>
<input type='button' class="btn btn-success"
 style="height:50px; width:190px;"
 onclick="_botconnect(1,'IamHere 모니터링(봇)')" value="모니터링용 봇 연결하기">
</div>

<div class='button'>
<input type='button' class="btn btn-warning"
 style="height:50px; width:190px;"
 onclick="_botconnect(2,'IamHere 공지(봇)')" value="공지용 봇 연결하기">
</div>
